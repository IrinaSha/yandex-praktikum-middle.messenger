...
[Ссылка на собранную версию Спринт 3](https://messenger-shabliy.netlify.app/)
...
Для проверки уязвимостей используйте команду 

`npm audit`

При попытке commit и push осуществляется проверка отправляемых изменений (precommit) в случае простых ошибок
(неправильные отступы) правки делаются автоматически
Если найдены более сложные ошибки (неиспользуемая переменная) commit будет отклонен
